...
Перейдите во вкладку [релизов](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) и скачайте последнюю версию. Эти действия сделает модератор самостоятельно, не стоит ему в этом мешать!
